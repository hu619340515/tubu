/**
 * Coordinate Transformation Utility between WGS84 (GPS) and GCJ02 (Mars Coordinates)
 * Accurately aligns WGS84 outdoor hiking GPS tracks to domestic Chinese satellite & terrain maps (AMap).
 */
